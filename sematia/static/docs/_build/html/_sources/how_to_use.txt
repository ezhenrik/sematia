...
**Writer and author**
    ...
    - For the people involved, it is possible to add the Person ID number used in Trismegistos People (http://www.trismegistos.org/ref/index.php). For example, add “12813” from “www.trismegistos.org/person/12813” for Ptolemaios, son of Glaukias, who lived in Memphis in the Hellenistic period. (NB! this should be the *person* ID, not name ID!)
